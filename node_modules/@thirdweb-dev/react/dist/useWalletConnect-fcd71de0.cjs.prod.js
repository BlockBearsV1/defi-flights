...
var localWallet$1 = require('@thirdweb-dev/wallets/evm/wallets/local-wallet');
...
const isCredentialsSupported = typeof window !== "undefined" && "PasswordCredential" in window;
...
class LocalWalletWeb extends wallets.LocalWallet {
  async autoConnect() {
...
const localWallet = () => {
  return {
    ...
    create: options => new LocalWalletWeb(options)
  };
};
...
const coinbaseWallet = () => {
  return {
    ...
    meta: wallets.CoinbaseWallet.meta,
    create: options => new wallets.CoinbaseWallet({
      ...options,
      headlessMode: true
    })
  };
...
const metamaskWallet = () => {
  return {
    ...
    create: options => new wallets.MetaMaskWallet({
      ...options,
      qrcode: false
    })
  };
...
const defaultChainIcon = reactCore.resolveIpfsUri("ipfs://QmcxZHpyJa8T4i63xqjPYrZ6tKrt55tZJpbXcjSDKuKaf9/ethereum/512.png");
const ChainIcon = props => {
  const url = props.chain?.icon?.url;
  const src = url ? reactCore.resolveIpfsUri(url) : defaultChainIcon;
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    }), props.active && /*#__PURE__*/jsxRuntime.jsx(ActiveDot, {})]
  });
};
...
const slideUpAndFade$1 = react.keyframes`
from {
  opacity: 0;
...
const CopyIcon = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(ToolTip, {
      ...
      side: props.side,
      align: props.align,
      children: hasCopied ? /*#__PURE__*/jsxRuntime.jsx(CheckIconStyled, {}) : /*#__PURE__*/jsxRuntime.jsx(reactIcons.CopyIcon, {})
    })
  });
};
    ...
    children: [props.trigger && /*#__PURE__*/jsxRuntime.jsx(Dialog__namespace.Trigger, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(Dialog__namespace.Overlay, {
        ...
        children: /*#__PURE__*/jsxRuntime.jsxs(DialogContent, {
          style: props.style,
          children: [props.title && /*#__PURE__*/jsxRuntime.jsxs(DialogTitle, {
...
`;
const DialogTitle = styled__default["default"](Dialog__namespace.Title)`
  margin: 0;
  font-weight: 500;
  color: ${p => p.theme.text.neutral};
...
`;
const ErrorMessage$2 = styled__default["default"].p`
  all: unset;
  font-size: ${fontSize.sm};
  display: block;
...
const NetworkSelector = props => {
  ...
  const themeFromProvider = React.useContext(reactCore.ThirdwebThemeContext);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(react.ThemeProvider, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(Modal, {
      open: true,
      setOpen: value => {
        if (!value && onClose) {
          onClose();
      ...
      return /*#__PURE__*/jsxRuntime.jsx("li", {
        children: /*#__PURE__*/jsxRuntime.jsxs(NetworkButton, {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(ChainIcon, {
            ...
            children: [chainName, /*#__PURE__*/jsxRuntime.jsxs("div", {
              style: {
                display: "flex",
                gap: spacing.xs
              },
              children: [confirming && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
                children: [/*#__PURE__*/jsxRuntime.jsx(ConfirmMessage$1, {
                  children: "Confirm in Wallet"
                }), /*#__PURE__*/jsxRuntime.jsx(Spinner, {
                  size: "sm",
                  color: "link"
                })]
              }), switchingFailed && /*#__PURE__*/jsxRuntime.jsx(ErrorMessage$1, {
...
`;
const ConfirmMessage$1 = styled__default["default"].div`
  font-size: ${fontSize.sm};
...
const LocalWalletInfoCtx = /*#__PURE__*/React.createContext(undefined);
const LocalWalletInfoProvider = props => {
  const [walletData, setWalletData] = React.useState("loading");
  const createWalletInstance = reactCore.useCreateWalletInstance();
  const localWalletObj = reactCore.useSupportedWallet("localWallet");
  const [localWallet, setLocalWallet] = React.useState(null);
  const activeWallet = reactCore.useWallet();
  const prevActiveWallet = React.useRef(activeWallet);
  ...
  React.useEffect(() => {
    const wallet = createWalletInstance(localWalletObj);
    setLocalWallet(wallet);
    wallet.getSavedData().then(data => {
      setWalletData(data);
    });
  }, [createWalletInstance, localWalletObj]);
  return /*#__PURE__*/jsxRuntime.jsx(LocalWalletInfoCtx.Provider, {
    value: {
      setLocalWallet,
      localWallet,
      walletData,
...
function useLocalWalletInfo() {
  const ctx = React.useContext(LocalWalletInfoCtx);
  if (!ctx) {
    throw new Error("useLocalWalletInfo() must be used within a LocalWalletInfoProvider");
  }
  return ctx;
}
...
const FormFieldWithIconButton = props => {
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    children: [/*#__PURE__*/jsxRuntime.jsx(Label, {
      ...
      }), /*#__PURE__*/jsxRuntime.jsx(InputButton, {
        type: "button",
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(Spacer, {
        y: "sm"
      }), /*#__PURE__*/jsxRuntime.jsxs(ErrorMessage$2, {
...
const FormField = props => {
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    children: [/*#__PURE__*/jsxRuntime.jsx(Label, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(Spacer, {
        y: "xs"
      }), /*#__PURE__*/jsxRuntime.jsx(ErrorMessage$2, {
...
const ExportLocalWallet = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(LocalWalletModalHeader, {
      onBack: props.onBack
    }), /*#__PURE__*/jsxRuntime.jsx(ModalTitle, {
      style: {
        textAlign: "left"
      },
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(Label, {
        ...
        children: shortenAddress(address || "") || "Loading..."
      }), /*#__PURE__*/jsxRuntime.jsx(Spacer, {
        y: "lg"
      }), /*#__PURE__*/jsxRuntime.jsx("input", {
        type: "text",
      ...
      }), /*#__PURE__*/jsxRuntime.jsx(FormFieldWithIconButton, {
        noSave: true,
        required: true,
...
const ConnectedWalletDetails = props => {
  ...
  const activeWallet = reactCore.useWallet();
  const walletContext = reactCore.useThirdwebWallet();
  const [personalWalletBalance, setPersonalWalletBalance] = React.useState(undefined);
  const [personalWalletAddress, setPersonalWalletAddress] = React.useState(undefined);
  const [showExportModal, setShowExportModal] = React.useState(false);
  const chain = React.useMemo(() => {
    return chains$1.find(_chain => _chain.chainId === walletChainId);
  }, [walletChainId, chains$1]);
  const unknownChain = React.useMemo(() => {
    if (!chain) {
      return chains.defaultChains.find(c => c.chainId === walletChainId);
    }
  }, [walletChainId, chain]);
  ...
  const isWrapperWallet = activeWallet?.walletId === "Safe" || activeWallet?.walletId === "SmartWallet";
  const personalWallet = isWrapperWallet ? activeWallet.getPersonalWallet() // assumes using a client wallet
  : undefined;
  ...
  React.useEffect(() => {
    ...
    personalWallet.getSigner().then(signer => {
      signer.getBalance().then(balance => {
        setPersonalWalletBalance(ethers.utils.formatEther(balance));
      });
    });
  }, [personalWallet]);
  const trigger = /*#__PURE__*/jsxRuntime.jsxs(WalletInfoButton, {
    type: "button",
    ...
    }), /*#__PURE__*/jsxRuntime.jsxs(ColFlex, {
      children: [!balanceQuery.isLoading ? /*#__PURE__*/jsxRuntime.jsxs(WalletBalance, {
        ...
        y: "xs"
      }), /*#__PURE__*/jsxRuntime.jsx(WalletAddress, {
  ...
  const networkSwitcherButton = /*#__PURE__*/jsxRuntime.jsxs(MenuButton, {
    id: "current-network",
    type: "button",
    ...
    }), chain?.name || unknownChain?.name || `Unknown chain #${walletChainId}`, /*#__PURE__*/jsxRuntime.jsx(StyledChevronRightIcon, {
      width: iconSize.sm,
      height: iconSize.sm,
      style: {
        flexShrink: 0,
  ...
  const switchToPersonalWallet = personalWallet && /*#__PURE__*/jsxRuntime.jsxs(MenuButton, {
    type: "button",
    onClick: () => {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      children: [personalWalletBalance ? /*#__PURE__*/jsxRuntime.jsxs(WalletBalance, {
  ...
  const content = /*#__PURE__*/jsxRuntime.jsxs("div", {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(Img, {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsxs(Flex, {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsxs("div", {
            ...
            children: [/*#__PURE__*/jsxRuntime.jsxs(AccountAddress, {
              children: [" ", shortenString(address || "")]
        ...
        }), /*#__PURE__*/jsxRuntime.jsxs(AccountBalance, {
          children: [" ", balanceQuery.data?.displayValue.slice(0, 5), " ", balanceQuery.data?.symbol, " "]
        })]
      })]
    }), /*#__PURE__*/jsxRuntime.jsx(Spacer, {
    ...
    }), personalWallet && /*#__PURE__*/jsxRuntime.jsxs("div", {
      children: [/*#__PURE__*/jsxRuntime.jsx(Spacer, {
        y: "lg"
      }), /*#__PURE__*/jsxRuntime.jsx(DropdownLabel, {
        htmlFor: "current-network",
    ...
    }), activeWallet?.walletId === "metamask" && /*#__PURE__*/jsxRuntime.jsxs("div", {
      children: [/*#__PURE__*/jsxRuntime.jsx(Spacer, {
        y: "md"
      }), /*#__PURE__*/jsxRuntime.jsxs(MenuButton, {
        type: "button",
        onClick: () => {
    ...
    }), (chain?.faucets && chain.faucets.length > 0 || chain?.chainId === chains.Localhost.chainId) && /*#__PURE__*/jsxRuntime.jsxs("div", {
      children: [/*#__PURE__*/jsxRuntime.jsx(Spacer, {
        y: "md"
      }), /*#__PURE__*/jsxRuntime.jsxs(MenuLink, {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(SecondaryIconContainer, {
          children: /*#__PURE__*/jsxRuntime.jsx(FundsIcon, {
            size: iconSize.sm
          })
        }), "Request Testnet Funds"]
      })]
    }), activeWallet?.walletId === "localWallet" && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [/*#__PURE__*/jsxRuntime.jsx(Spacer, {
        y: "sm"
      }), /*#__PURE__*/jsxRuntime.jsxs(MenuButton, {
        onClick: () => {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(SecondaryIconContainer, {
          children: /*#__PURE__*/jsxRuntime.jsx(GenericWalletIcon, {
            size: iconSize.sm
          })
        }), "Export Wallet", " "]
      })]
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [isMobile() ? /*#__PURE__*/jsxRuntime.jsx(Modal, {
      trigger: trigger,
      open: open,
      setOpen: setOpen,
      hideCloseIcon: true,
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(LocalWalletInfoProvider, {
...
`;
const WalletAddress = styled__default["default"].span`
  color: ${props => props.theme.text.secondary};
  font-size: ${fontSize.xs};
  font-weight: 500;
`;
const ColFlex = styled__default["default"].div`
  display: flex;
  flex-direction: column;
`;
const WalletBalance = styled__default["default"].span`
  color: ${props => props.theme.text.neutral};
  font-size: ${fontSize.sm};
  font-weight: 500;
`;
const AccountAddress = styled__default["default"].span`
  font-size: ${fontSize.md};
  color: ${props => props.theme.text.neutral};
  font-weight: 500;
`;
const AccountBalance = styled__default["default"].span`
  font-size: ${fontSize.sm};
  color: ${props => props.theme.text.secondary};
  font-weight: 500;
`;
...
const StyledChevronRightIcon = styled__default["default"](reactIcons.ChevronRightIcon)`
  color: ${props => props.theme.text.secondary};
`;
const DisconnectIconButton = styled__default["default"](IconButton)`
...
`;
const SecondaryIconContainer = styled__default["default"].div`
  display: flex;
  align-items: center;
  justify-content: center;
  color: ${props => props.theme.icon.secondary};
...
const WalletWrapperConnection = /*#__PURE__*/React.createContext(false);
const SetWalletWrapperConnection = /*#__PURE__*/React.createContext(undefined);
const WalletModalOpen = /*#__PURE__*/React.createContext(false);
const SetWalletModalOpen = /*#__PURE__*/React.createContext(undefined);
const ScreenContext = /*#__PURE__*/React.createContext("walletList");
const SetScreenContext = /*#__PURE__*/React.createContext(undefined);
const ModalThemeContext = /*#__PURE__*/React.createContext("dark");
const SetModalThemeContext = /*#__PURE__*/React.createContext(undefined);
const WalletUIStatesProvider = props => {
  const [isConnectingToWalletWrapper, setIsConnectingToWalletWrapper] = React.useState(false);
  const [isWalletModalOpen, setIsWalletModalOpen] = React.useState(false);
  const [screen, setScreen] = React.useState("walletList");
  const [modalTheme, setModalTheme] = React.useState(props.theme || "dark");
  return /*#__PURE__*/jsxRuntime.jsx(WalletWrapperConnection.Provider, {
    value: isConnectingToWalletWrapper,
    children: /*#__PURE__*/jsxRuntime.jsx(SetWalletWrapperConnection.Provider, {
      value: setIsConnectingToWalletWrapper,
      children: /*#__PURE__*/jsxRuntime.jsx(WalletModalOpen.Provider, {
        value: isWalletModalOpen,
        children: /*#__PURE__*/jsxRuntime.jsx(SetWalletModalOpen.Provider, {
          value: setIsWalletModalOpen,
          children: /*#__PURE__*/jsxRuntime.jsx(ScreenContext.Provider, {
            value: screen,
            children: /*#__PURE__*/jsxRuntime.jsx(SetScreenContext.Provider, {
              value: setScreen,
              children: /*#__PURE__*/jsxRuntime.jsx(ModalThemeContext.Provider, {
                value: modalTheme,
                children: /*#__PURE__*/jsxRuntime.jsx(SetModalThemeContext.Provider, {
                  value: setModalTheme,
                  children: props.children
                })
              })
...
const useIsConnectingToWalletWrapper = () => {
  return React.useContext(WalletWrapperConnection);
};
const useIsWalletModalOpen = () => {
  return React.useContext(WalletModalOpen);
};
const useSetIsConnectingToWalletWrapper = () => {
  const context = React.useContext(SetWalletWrapperConnection);
  if (context === undefined) {
    throw new Error("useSetIsConnectingToWalletWrapper must be used within a UIProvider");
  }
  return context;
};
...
const useSetScreen = () => {
  const context = React.useContext(SetScreenContext);
  if (context === undefined) {
...
const useSetModalTheme = () => {
  const context = React.useContext(SetModalThemeContext);
  if (context === undefined) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(Modal, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(Container, {
      children: [/*#__PURE__*/jsxRuntime.jsx(Img, {
        ...
        y: "xl"
      }), /*#__PURE__*/jsxRuntime.jsxs(TitleContainer$1, {
        ...
        y: "md"
      }), /*#__PURE__*/jsxRuntime.jsx(Desc$1, {
...
`;
const Desc$1 = styled__default["default"](ModalDescription)`
  ${media.mobile} {
    max-width: 240px;
    margin: 0 auto;
  }
...
const ConnectWallet = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(react.ThemeProvider, {
    ...
    }), !requiresSignIn && (!activeWallet || isConnectingToWalletWrapper ?
    /*#__PURE__*/
    // connect wallet button
    jsxRuntime.jsx(AnimatedButton, {
      disabled: isLoading,
    ...
    }) : /*#__PURE__*/jsxRuntime.jsx(ConnectedWalletDetails, {
...
const AnimatedButton = styled__default["default"](Button)`
  animation: ${fadeInAnimation} 300ms ease;
`;
...
const ModelViewer = /*#__PURE__*/React.lazy(() => Promise.resolve().then(function () { return require('./ModelViewer-d9a72fb7.cjs.prod.js'); }));
...
function useResolvedMediaType(uri, mimeType) {
  const resolvedUrl = React.useMemo(() => reactCore.resolveIpfsUri(uri), [uri]);
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(RXPopover__namespace.Root, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(RXPopover__namespace.Trigger, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs(PopoverContent, {
        sideOffset: 7,
        side: "top",
        children: [/*#__PURE__*/jsxRuntime.jsx(FlexWrapper, {
...
`;
const FlexWrapper = styled__default["default"].div`
  display: flex;
  align-items: center;
  gap: ${spacing.sm};
`;
...
const Web3Button = _ref => {
  ...
  const thirdwebTheme = React.useContext(reactCore.ThirdwebThemeContext);
  ...
  if (hasMismatch && !isDisabled) {
    const _button = /*#__PURE__*/jsxRuntime.jsx(Button, {
      variant: "inverted",
      type: type,
      ...
      "data-theme": theme,
      children: confirmStatus === "waiting" ? /*#__PURE__*/jsxRuntime.jsx(Spinner, {
        size: "sm",
        color: "inverted"
      }) : "Switch Network"
    });
...
const WalletSelector = props => {
  ...
  const walletsMeta = props.walletsMeta.filter(w => w.id !== "localWallet" && w.id !== "SmartWallet");
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(ModalTitle, {
      ...
      y: "xl"
    }), smartWalletMeta && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [/*#__PURE__*/jsxRuntime.jsxs("div", {
        style: {
          position: "relative"
        },
    ...
    }), props.guestMode && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [/*#__PURE__*/jsxRuntime.jsx(Spacer, {
        y: "xl"
      ...
      return /*#__PURE__*/jsxRuntime.jsx("li", {
        children: /*#__PURE__*/jsxRuntime.jsxs(WalletButton, {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(Img, {
            ...
            children: walletMeta.meta.name
          }), walletMeta.installed && /*#__PURE__*/jsxRuntime.jsx(InstallBadge, {
            children: " Installed "
          })]
        })
      }, walletMeta.id);
...
const ConnectingScreen = props => {
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(BackButton, {
      onClick: props.onBack
    }), /*#__PURE__*/jsxRuntime.jsx(IconContainer$1, {
      children: /*#__PURE__*/jsxRuntime.jsx(Img, {
...
const CoinbaseWalletSetup = _ref => {
  ...
  const coinbaseWalletObj = reactCore.useSupportedWallet("coinbaseWallet");
...
const MetamaskConnecting = props => {
  const metamask = reactCore.useSupportedWallet("metamask");
  return /*#__PURE__*/jsxRuntime.jsx(ConnectingScreen, {
    onBack: props.onBack,
...
const MetamaskGetStarted = props => {
  const wallet = reactCore.useSupportedWallet("metamask");
  return /*#__PURE__*/jsxRuntime.jsx(GetStartedScreen, {
...
const ScanMetamask = props => {
  const metamaskWallet = reactCore.useSupportedWallet("metamask");
  const createInstance = reactCore.useCreateWalletInstance();
...
const SelectpersonalWallet = props => {
  const safeWalletObj = reactCore.useSupportedWallet("Safe");
  console.log("wallets meta", props.walletsMeta, props.guestMode);
  const walletsMeta = props.walletsMeta.filter(w => w.id !== "SmartWallet" && w.id !== "Safe" && w.id !== "localWallet");
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(BackButton, {
      ...
      y: "xl"
    }), showGuest ? /*#__PURE__*/jsxRuntime.jsx(Button, {
      variant: "link",
...
const SafeForm = props => {
  ...
  const activeChain = reactCore.useActiveChain();
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(BackButton, {
      ...
      children: ["You can find your safe address in", " ", /*#__PURE__*/jsxRuntime.jsx(HelperLink, {
        target: "_blank",
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(FormField, {
        name: "safeAddress",
        id: "safeAddress",
        ...
        }), !disableNetworkSelection && /*#__PURE__*/jsxRuntime.jsx(reactIcons.ChevronDownIcon, {
          width: iconSize.sm,
          height: iconSize.sm,
          style: {
            position: "absolute",
        ...
        y: "sm"
      }), safeConnectError && /*#__PURE__*/jsxRuntime.jsxs(ErrorMessage$2, {
        style: {
          display: "flex",
          gap: spacing.sm,
          alignItems: "center",
      ...
      }), switchError && /*#__PURE__*/jsxRuntime.jsxs(ErrorMessage$2, {
        style: {
          display: "flex",
          gap: spacing.sm,
          alignItems: "center",
        ...
        children: mismatch ? /*#__PURE__*/jsxRuntime.jsxs(Button, {
          type: "button",
          variant: "secondary",
          style: {
            display: "flex",
          ...
          children: [" ", switchingNetwork ? "Switching" : "Switch Network", switchingNetwork && /*#__PURE__*/jsxRuntime.jsx(Spinner, {
            size: "sm",
            color: "primary"
          })]
        }) : /*#__PURE__*/jsxRuntime.jsxs(Button, {
          ...
          children: [connectionStatus === "connecting" ? "Connecting" : "Connect to Safe", connectionStatus === "connecting" && /*#__PURE__*/jsxRuntime.jsx(Spinner, {
            size: "sm",
            color: "inverted"
          })]
        })
...
const SecondaryText = styled__default["default"].span`
  font-size: ${fontSize.md};
  color: ${p => p.theme.text.secondary};
  margin: 0;
`;
  ...
  return /*#__PURE__*/jsxRuntime.jsx(GetStartedScreen, {
    ...
    header: /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [/*#__PURE__*/jsxRuntime.jsx(ModalTitle, {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(SecondaryText, {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(Img, {
            ...
            width: iconSize.md,
            height: iconSize.md
          }), /*#__PURE__*/jsxRuntime.jsx(NeutralText, {
            children: meta.name
          })]
        })]
      })]
...
const NeutralText = styled__default["default"].p`
  font-size: ${fontSize.md};
  color: ${p => p.theme.text.neutral};
  margin: 0;
`;
...
const ImportLocalWallet = props => {
  ...
  const handleImport = async () => {
    const localWallet = createWalletInstance(localWalletObj);
...
const CreateLocalWallet_Creds = props => {
  const {
    localWallet
  } = useLocalWalletInfo();
  const thirdwebWalletContext = reactCore.useThirdwebWallet();
  ...
  if (showExport) {
    return /*#__PURE__*/jsxRuntime.jsx(ExportLocalWallet, {
      onBack: () => {
        setShowExport(false);
      },
      onExport: () => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(LocalWalletModalHeader, {
      ...
      children: "Create a new wallet or import an existing one."
    }), /*#__PURE__*/jsxRuntime.jsx(Spacer, {
      y: "lg"
    }), /*#__PURE__*/jsxRuntime.jsx(Button, {
      variant: "inverted",
...
const CreateLocalWallet_NoCreds = props => {
  const [password, setPassword] = React.useState("");
  ...
  const isGenerated = React.useRef(false);
  React.useEffect(() => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(LocalWalletModalHeader, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(SecondaryText, {
        ...
        y: "xl"
      }), /*#__PURE__*/jsxRuntime.jsxs(FormFooter, {
        children: [/*#__PURE__*/jsxRuntime.jsx(Button, {
          variant: "inverted",
 ...
 */
const ReconnectLocalWalletNoCredentials = props => {
  const {
    walletData,
    localWallet
  } = useLocalWalletInfo();
  ...
  if (showCreate) {
    return /*#__PURE__*/jsxRuntime.jsx(CreateLocalWallet_NoCreds, {
      onBack: () => {
        setShowCreate(false);
      },
      onConnected: props.onConnected
  ...
  const address = (walletData === "loading" || !walletData ? "Fetching..." : walletData.address) || "";
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(LocalWalletModalHeader, {
      onBack: props.onBack
    }), /*#__PURE__*/jsxRuntime.jsx(ModalTitle, {
      ...
      y: "sm"
    }), /*#__PURE__*/jsxRuntime.jsx(SecondaryText, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx("input", {
        ...
        children: /*#__PURE__*/jsxRuntime.jsxs(Button, {
          ...
          children: ["Connect", isConnecting && /*#__PURE__*/jsxRuntime.jsx(Spinner, {
            size: "sm",
            color: "inverted"
          })]
        })
...
const ReconnectLocalWalletCredentials = props => {
  const {
    localWallet
  } = useLocalWalletInfo();
  const thirdwebWalletContext = reactCore.useThirdwebWallet();
  ...
  if (showCreate) {
    return /*#__PURE__*/jsxRuntime.jsx(CreateLocalWallet_Creds, {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(LocalWalletModalHeader, {
      ...
      y: "sm"
    }), /*#__PURE__*/jsxRuntime.jsxs(AddressButton, {
      variant: "secondary",
      onClick: handleConnect,
      children: [shortenAddress(props.creds.id || "") || "Fetching...", /*#__PURE__*/jsxRuntime.jsx(reactIcons.ChevronRightIcon, {
        style: {
          marginLeft: "auto"
        }
      })]
...
const AddressButton = styled__default["default"](Button)`
  font-size: ${fontSize.md};
  margin: 0;
  width: 100%;
...
const LocalWalletSetup = props => {
  ...
  if (isLoading) {
    return /*#__PURE__*/jsxRuntime.jsx(LoadingSpinnerContainer, {
      children: /*#__PURE__*/jsxRuntime.jsx(Spinner, {
        size: "lg",
        color: "primary"
      })
  ...
  if (isCredentialsSupported) {
    ...
    return /*#__PURE__*/jsxRuntime.jsx(ReconnectLocalWalletCredentials, {
      ...props,
      creds: savedCreds
    });
  }
  ...
  if (walletData) {
    return /*#__PURE__*/jsxRuntime.jsx(ReconnectLocalWalletNoCredentials, {
      onConnected: props.onConnected,
      onBack: props.onBack
    });
  }
...
const LoadingSpinnerContainer = styled__default["default"].div`
  height: 300px;
  display: flex;
  align-items: center;
  justify-content: center;
...
const SmartWalletConnection = props => {
  if (!isCredentialsSupported) {
    return /*#__PURE__*/jsxRuntime.jsx("p", {
      children: " Credential storage not supported "
    });
  }
  return /*#__PURE__*/jsxRuntime.jsx(SmartWalletConnection_CredsWrapper, {
    ...props
  });
};
function useInitializeLocalWalletWithCreds() {
  ...
  const thirdwebWalletContext = reactCore.useThirdwebWallet();
  const localWalletInitialized = React.useRef(false);
  const gettingCreds = React.useRef(false);
  const [generatedRandom, setGeneratedRandom] = React.useState(false);

  // initialize the localWallet from credentials or generate a new one
  React.useEffect(() => {
    if (!localWallet || localWalletInitialized.current || !isCredentialsSupported) {
      return;
    }
    (async () => {
      ...
      if (creds && localWallet$1.isValidPrivateKey(creds.password)) {
...
const SmartWalletConnection_CredsWrapper = props => {
  const {
    localWallet,
    generatedRandom
  } = useInitializeLocalWalletWithCreds();
  const chain = reactCore.useThirdwebWallet()?.activeChain;
  if (!localWallet || !chain) {
    return /*#__PURE__*/jsxRuntime.jsxs(Flex, {
      ...
      children: [generatedRandom ? /*#__PURE__*/jsxRuntime.jsx(SecondaryText, {
        children: " Generating Wallet "
      }) : /*#__PURE__*/jsxRuntime.jsx(SecondaryText, {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(SmartWalletConnection_Creds, {
    ...props,
    localWallet: localWallet,
    chain: chain
  });
};
const SmartWalletConnection_Creds = props => {
  const {
    localWallet,
    chain
  } = props;
  const walletObj = reactCore.useSupportedWallet("SmartWallet");
  const connect = reactCore.useConnect();
  const [userName, setUserName] = React.useState(props.username);
  const userNameNow = React.useRef(userName);
  const connectionStatus = reactCore.useConnectionStatus();
  const [canConnect, setCanConnect] = React.useState(false);
  const [isValidating, setIsValidating] = React.useState(true);
  const [showImport, setShowImport] = React.useState(false);
  const [validateOnMount, setValidateOnMount] = React.useState(true);
  const [isConnecting, setIsConnecting] = React.useState(false);
  ...
  const handleUserNameChange = React.useCallback(async name => {
    if (!chain || !localWallet) {
      return;
    }
    setIsValidating(true);
    console.log("checking if available....");
    const isAvailable = await wallets.isAccountIdAvailable(name, walletObj.factoryAddress, chain);
    ...
    if (isAvailable) {
      ...
      // this is slow
      const accounts = await wallets.getAssociatedAccounts(localWallet, walletObj.factoryAddress, chain);

      // if username has since changed, ignore
      if (name !== userNameNow.current) {
        return;
      }
      const ownsAccount = accounts.some(a => a.accountId === userNameNow.current);
      setIsValidating(false);
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(BackButton, {
      ...
      children: "Choose account"
    }), /*#__PURE__*/jsxRuntime.jsx(Spacer, {
      y: "sm"
    }), /*#__PURE__*/jsxRuntime.jsx(ModalDescription, {
      children: "Connect your existing account or create a new one"
    }), /*#__PURE__*/jsxRuntime.jsx(Spacer, {
      y: "xl"
    }), /*#__PURE__*/jsxRuntime.jsxs("form", {
      onSubmit: e => {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsxs("div", {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(FormField, {
          name: "accountId",
          id: "accountId",
          errorMessage: showError ? /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
            children: ["Username is not available ", /*#__PURE__*/jsxRuntime.jsx("br", {})]
          }) : undefined,
          autocomplete: "on",
          onChange: value => {
            setUserName(value);
          ...
          value: userName,
          required: true
        }), isValidating && /*#__PURE__*/jsxRuntime.jsx("div", {
          style: {
            position: "absolute",
            top: "40px",
            right: spacing.md
      ...
      }), showError && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
        children: [/*#__PURE__*/jsxRuntime.jsx(Spacer, {
          y: "sm"
        }), /*#__PURE__*/jsxRuntime.jsx(SecondaryText, {
          style: {
          ...
          children: "Choose a different username if you want to create a new account OR import the wallet that owns this username"
        })]
      }), /*#__PURE__*/jsxRuntime.jsx(Spacer, {
        y: "xl"
      }), /*#__PURE__*/jsxRuntime.jsxs(FormFooter, {
        children: [showError && /*#__PURE__*/jsxRuntime.jsx(Button, {
          variant: "inverted",
          type: "button",
          onClick: () => {
            setShowImport(true);
          ...
          children: [connectionStatus === "connecting" ? "Connecting" : "Connect", connectionStatus === "connecting" && /*#__PURE__*/jsxRuntime.jsx(Spinner, {
            size: "sm",
            color: "inverted"
          })]
        })]
...
const ConnectModal = _ref => {
  ...
  const content = /*#__PURE__*/jsxRuntime.jsx(react.ThemeProvider, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(Modal, {
      ...
      children: [showScreen === "walletList" && /*#__PURE__*/jsxRuntime.jsx(WalletSelector, {
        walletsMeta: walletsMeta,
        onGetStarted: () => {
      ...
      }), showScreen === "metamask/get-started" && /*#__PURE__*/jsxRuntime.jsx(MetamaskGetStarted, {
        onBack: () => {
          setShowScreen("metamask/scan");
        }
      }), showScreen === "coinbase/get-started" && /*#__PURE__*/jsxRuntime.jsx(CoinbaseGetStarted, {
        onBack: () => {
          setShowScreen("coinbase/scan");
        }
      }), showScreen === "metamask/connecting" && /*#__PURE__*/jsxRuntime.jsx(MetamaskConnecting, {
        onBack: handleBack
      }), showScreen === "metamask/scan" && /*#__PURE__*/jsxRuntime.jsx(ScanMetamask, {
        onBack: handleBack,
        onConnected: onConnect,
        onGetStarted: () => {
          setShowScreen("metamask/get-started");
        }
      }), showScreen === "coinbase/scan" && /*#__PURE__*/jsxRuntime.jsx(ScanCoinbase, {
        onBack: handleBack,
        onConnected: onConnect,
        onGetStarted: () => {
          setShowScreen("coinbase/get-started");
        }
      }), showScreen === "coinbase/connecting" && /*#__PURE__*/jsxRuntime.jsx(CoinbaseWalletSetup, {
        onBack: handleBack
      }), showScreen === "safe/select-wallet" && /*#__PURE__*/jsxRuntime.jsx(SelectpersonalWallet, {
        guestMode: guestMode,
        onBack: () => {
          setIsConnectingToWalletWrapper(false);
          setShowScreen("walletList");
        ...
        walletsMeta: walletsMeta
      }), showScreen === "safe/form" && /*#__PURE__*/jsxRuntime.jsx(SafeForm, {
        onBack: handleBack,
        onConnect: () => {
          closeModalAndReset();
        }
      }), showScreen === "wallets/get-started" && /*#__PURE__*/jsxRuntime.jsx(GetStartedWithWallets, {
        onBack: handleBack,
        walletMeta: walletsMeta[0]
      }), showScreen === "localWallet/connect" && /*#__PURE__*/jsxRuntime.jsx(LocalWalletSetup, {
        onBack: handleBack,
        onConnected: onConnect
      }), showScreen === "smartWallet/form" && /*#__PURE__*/jsxRuntime.jsx(SmartWalletConnection, {
        username: username,
        onBack: handleBack,
        onConnect: () => {
          closeModalAndReset();
  ...
  return usingLocalWallet ? /*#__PURE__*/jsxRuntime.jsxs(LocalWalletInfoProvider, {
    children: [" ", content]
  }) : content;
};
...
const ThirdwebProvider = _ref => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(WalletUIStatesProvider, {
    theme: theme,
    children: /*#__PURE__*/jsxRuntime.jsx(react.ThemeProvider, {
      theme: theme === "dark" ? darkTheme : lightTheme,
...
function usePaperWallet() {
  ...
  return React.useCallback(async options => {
    const {
      paperWallet
    } = await Promise.resolve().then(function () { return require('./paperWallet-03f69da0.cjs.prod.js'); });
    connect(paperWallet({
...
function useWalletConnect() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnect
    } = await Promise.resolve().then(function () { return require('./walletConnect-a660b048.cjs.prod.js'); });
