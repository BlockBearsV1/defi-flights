...
const ModelViewer = /*#__PURE__*/React.lazy(() => Promise.resolve().then(function () { return require('./ModelViewer-04256e81.cjs.dev.js'); }));
...
function usePaperWallet() {
  ...
  return React.useCallback(async options => {
    const {
      paperWallet
    } = await Promise.resolve().then(function () { return require('./paperWallet-8b8249cc.cjs.dev.js'); });
    connect(paperWallet({
...
function useWalletConnect() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnect
    } = await Promise.resolve().then(function () { return require('./walletConnect-69a98c9e.cjs.dev.js'); });
