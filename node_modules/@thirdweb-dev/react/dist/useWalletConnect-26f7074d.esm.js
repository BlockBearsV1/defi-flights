import React, { useState, useCallback, useEffect, useDeferredValue, useContext, useMemo, memo, useRef, createContext, Suspense, lazy } from 'react';
import { jsxs, jsx, Fragment } from 'react/jsx-runtime';
import { useQuery, useQueryClient, useMutation } from '@tanstack/react-query';
import { resolveIpfsUri, ThirdwebThemeContext, useSupportedChains, useSwitchChain, useChainId, useCreateWalletInstance, useSupportedWallet, useWallet, useDisconnect, useAddress, useBalance, useThirdwebWallet, useSDK, useConnectionStatus, useThirdwebAuthContext, useUser, useLogin, useLogout, resolveMimeType, useSDKChainId, useNetworkMismatch, useContract, useConnect, useActiveChain, useWallets, ThirdwebProviderCore } from '@thirdweb-dev/react-core';
...
import { CheckIcon, CopyIcon as CopyIcon$1, Cross2Icon, MagnifyingGlassIcon, ChevronLeftIcon, EyeClosedIcon, EyeOpenIcon, ChevronRightIcon, ShuffleIcon, ChevronDownIcon, ExclamationTriangleIcon, UploadIcon } from '@radix-ui/react-icons';
...
import { LocalWallet, CoinbaseWallet, MetaMaskWallet, WalletConnectV1, assertWindowEthereum, SafeSupportedChainsSet, isAccountIdAvailable, getAssociatedAccounts } from '@thirdweb-dev/wallets';
...
const LocalWalletInfoCtx = /*#__PURE__*/createContext(undefined);
const LocalWalletInfoProvider = props => {
  const [walletData, setWalletData] = useState("loading");
  const createWalletInstance = useCreateWalletInstance();
  const localWalletObj = useSupportedWallet("localWallet");
  ...
  return /*#__PURE__*/jsx(LocalWalletInfoCtx.Provider, {
    value: {
      setLocalWallet,
      localWallet,
      walletData,
...
const ConnectedWalletDetails = props => {
  ...
  const content = /*#__PURE__*/jsxs("div", {
    ...
    }), activeWallet?.walletId === "localWallet" && /*#__PURE__*/jsxs(Fragment, {
      children: [/*#__PURE__*/jsx(Spacer, {
        y: "sm"
      }), /*#__PURE__*/jsxs(MenuButton, {
        onClick: () => {
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [isMobile() ? /*#__PURE__*/jsx(Modal, {
      ...
      children: /*#__PURE__*/jsx(LocalWalletInfoProvider, {
...
const WalletWrapperConnection = /*#__PURE__*/createContext(false);
const SetWalletWrapperConnection = /*#__PURE__*/createContext(undefined);
...
const WalletUIStatesProvider = props => {
  const [isConnectingToWalletWrapper, setIsConnectingToWalletWrapper] = useState(false);
  const [isWalletModalOpen, setIsWalletModalOpen] = useState(false);
  const [screen, setScreen] = useState("walletList");
  const [modalTheme, setModalTheme] = useState(props.theme || "dark");
  return /*#__PURE__*/jsx(WalletWrapperConnection.Provider, {
    value: isConnectingToWalletWrapper,
    children: /*#__PURE__*/jsx(SetWalletWrapperConnection.Provider, {
...
const WalletSelector = props => {
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsx(ModalTitle, {
      ...
      y: "xl"
    }), smartWalletMeta && /*#__PURE__*/jsxs(Fragment, {
      children: [/*#__PURE__*/jsxs("div", {
        style: {
          position: "relative"
        },
    ...
    }), props.guestMode && /*#__PURE__*/jsxs(Fragment, {
      children: [/*#__PURE__*/jsx(Spacer, {
        y: "xl"
...
const ReconnectLocalWalletNoCredentials = props => {
  ...
  if (showCreate) {
    return /*#__PURE__*/jsx(CreateLocalWallet_NoCreds, {
      onBack: () => {
        setShowCreate(false);
      },
      onConnected: props.onConnected
...
const ReconnectLocalWalletCredentials = props => {
  ...
  if (showCreate) {
    return /*#__PURE__*/jsx(CreateLocalWallet_Creds, {
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsx(LocalWalletModalHeader, {
      ...
      y: "sm"
    }), /*#__PURE__*/jsxs(AddressButton, {
      variant: "secondary",
      onClick: handleConnect,
      children: [shortenAddress(props.creds.id || "") || "Fetching...", /*#__PURE__*/jsx(ChevronRightIcon, {
        style: {
          marginLeft: "auto"
        }
      })]
...
const LocalWalletSetup = props => {
  ...
  if (isCredentialsSupported) {
    ...
    return /*#__PURE__*/jsx(ReconnectLocalWalletCredentials, {
      ...props,
      creds: savedCreds
    });
  }
  ...
  if (walletData) {
    return /*#__PURE__*/jsx(ReconnectLocalWalletNoCredentials, {
      onConnected: props.onConnected,
      onBack: props.onBack
    });
  }
...
const SmartWalletConnection = props => {
  ...
  return /*#__PURE__*/jsx(SmartWalletConnection_CredsWrapper, {
    ...props
  });
};
...
const SmartWalletConnection_CredsWrapper = props => {
  ...
  if (!localWallet || !chain) {
    return /*#__PURE__*/jsxs(Flex, {
      ...
      children: [generatedRandom ? /*#__PURE__*/jsx(SecondaryText, {
  ...
  return /*#__PURE__*/jsx(SmartWalletConnection_Creds, {
    ...props,
...
const SmartWalletConnection_Creds = props => {
  ...
  const walletObj = useSupportedWallet("SmartWallet");
  const connect = useConnect();
  ...
  const handleUserNameChange = useCallback(async name => {
    if (!chain || !localWallet) {
      return;
    }
    setIsValidating(true);
    console.log("checking if available....");
    const isAvailable = await isAccountIdAvailable(name, walletObj.factoryAddress, chain);
    ...
    if (isAvailable) {
      ...
      // this is slow
      const accounts = await getAssociatedAccounts(localWallet, walletObj.factoryAddress, chain);
    ...
    children: [/*#__PURE__*/jsx(BackButton, {
      ...
      children: [/*#__PURE__*/jsxs("div", {
        ...
        children: [/*#__PURE__*/jsx(FormField, {
          name: "accountId",
          id: "accountId",
          errorMessage: showError ? /*#__PURE__*/jsxs(Fragment, {
            children: ["Username is not available ", /*#__PURE__*/jsx("br", {})]
          }) : undefined,
          autocomplete: "on",
          onChange: value => {
            setUserName(value);
      ...
      }), showError && /*#__PURE__*/jsxs(Fragment, {
        children: [/*#__PURE__*/jsx(Spacer, {
          y: "sm"
        }), /*#__PURE__*/jsx(SecondaryText, {
          style: {
        ...
        children: [showError && /*#__PURE__*/jsx(Button, {
          variant: "inverted",
          type: "button",
          onClick: () => {
            setShowImport(true);
          ...
          children: [connectionStatus === "connecting" ? "Connecting" : "Connect", connectionStatus === "connecting" && /*#__PURE__*/jsx(Spinner, {
            size: "sm",
            color: "inverted"
          })]
        })]
...
const ConnectModal = _ref => {
  ...
  const content = /*#__PURE__*/jsx(ThemeProvider, {
    ...
    children: /*#__PURE__*/jsxs(Modal, {
      ...
      }), showScreen === "localWallet/connect" && /*#__PURE__*/jsx(LocalWalletSetup, {
        onBack: handleBack,
        onConnected: onConnect
      }), showScreen === "smartWallet/form" && /*#__PURE__*/jsx(SmartWalletConnection, {
        username: username,
        onBack: handleBack,
        onConnect: () => {
          closeModalAndReset();
  ...
  return usingLocalWallet ? /*#__PURE__*/jsxs(LocalWalletInfoProvider, {
    children: [" ", content]
  }) : content;
};
