import type { AbstractClientWallet, Chain, DAppMetaData } from "@thirdweb-dev/wallets";
...
export type Wallet<I extends WalletInstance = WalletInstance, ExtraProps extends Record<string, any> = {}> = {
    id: string;
    meta: (typeof AbstractClientWallet)["meta"];
