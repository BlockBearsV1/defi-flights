 ...
 */
export declare function useWallet(): import("@thirdweb-dev/wallets").AbstractClientWallet<Record<string, any>, Record<string, any>> | undefined;
/**
 *
...
export declare function useWallets(): {
    ...
    create: (options: import("../..").WalletOptions) => import("@thirdweb-dev/wallets").AbstractClientWallet<Record<string, any>, Record<string, any>>;
}[];
/**
 *
 * @returns a method to connect to a wallet class
 */
export declare function useConnect(): <I extends import("@thirdweb-dev/wallets").AbstractClientWallet<Record<string, any>, Record<string, any>>>(...args: undefined extends Parameters<I["connect"]>[0] ? [wallet: {
    id: string;
    meta: import("@thirdweb-dev/wallets/dist/declarations/src/evm/wallets/base").WalletMeta;
    create: (options: import("../..").WalletOptions) => I;
}, connectParams?: (Parameters<I["connect"]>[0] extends infer T ? T extends Parameters<I["connect"]>[0] ? T extends null | undefined ? never : T : never : never) | undefined] : [wallet: {
    id: string;
    meta: import("@thirdweb-dev/wallets/dist/declarations/src/evm/wallets/base").WalletMeta;
    create: (options: import("../..").WalletOptions) => I;
}, connectParams: Parameters<I["connect"]>[0] extends infer T ? T extends Parameters<I["connect"]>[0] ? T extends null | undefined ? never : T : never : never]) => Promise<void>;
/**
 *
 ...
 *
 */
export declare function useIsConnecting(): boolean;
/**
 *
 * @returns a method to create an instance of given wallet class
 */
export declare function useCreateWalletInstance(): <I extends import("@thirdweb-dev/wallets").AbstractClientWallet<Record<string, any>, Record<string, any>>>(Wallet: {
    id: string;
    meta: import("@thirdweb-dev/wallets/dist/declarations/src/evm/wallets/base").WalletMeta;
    create: (options: import("../..").WalletOptions) => I;
}) => I;
