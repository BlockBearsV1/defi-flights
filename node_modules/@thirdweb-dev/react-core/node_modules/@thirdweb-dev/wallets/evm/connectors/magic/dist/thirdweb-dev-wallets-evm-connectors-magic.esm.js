...
class MagicBaseConnector extends WagmiConnector {
  constructor(config) {
    ...
    _defineProperty(this, "magicOptions", void 0);
...
class MagicAuthConnector extends MagicBaseConnector {
  ...
  constructor(config) {
    super(config);
    _defineProperty(this, "magicSDK", void 0);
    _defineProperty(this, "magicSdkConfiguration", void 0);
    ...
    _defineProperty(this, "oauthCallbackUrl", void 0);
