...
function useAccountSigners(contract) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.account.signers(contractAddress), () => {
    requiredParam.requiredParamInvariant(contract, "No Contract instance provided");
    invariant__default["default"](contract.account.getSignersWithRestrictions, "Contract instance does not support contract.account.getSignersWithRestrictions");
...
function useSetAccountSigners(contract) {
  ...
  const contractAddress = contract?.getAddress();
  const queryClient = reactQuery.useQueryClient();
  return reactQuery.useMutation(async permissionsSnapshot => {
    requiredParam.requiredParamInvariant(contract, "contract is undefined");
...
exports.useSetAccountSigners = useSetAccountSigners;
