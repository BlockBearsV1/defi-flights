 ...
 * @beta
 */
export declare function useAccounts(contract: RequiredParam<SmartContract>): UseQueryResult<AccountEvent[]>;
/**
 ...
 * @beta
 */
export declare function useCreateAccount(contract: RequiredParam<SmartContract>): import("@tanstack/react-query").UseMutationResult<import("@thirdweb-dev/sdk").TransactionResultWithAddress<never>, unknown, string, unknown>;
