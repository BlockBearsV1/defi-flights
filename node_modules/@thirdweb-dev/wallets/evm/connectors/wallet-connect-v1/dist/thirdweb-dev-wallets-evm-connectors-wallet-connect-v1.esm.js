...
import { C as Connector, U as UserRejectedRequestError, S as SwitchChainError } from '../../../../dist/errors-64449f60.esm.js';
...
class WalletConnectV1Connector extends Connector {
  ...
  async getProvider() {
    ...
    if (!_classPrivateFieldGet(this, _provider) || chainId || create) {
      ...
      const WalletConnectProvider = (await import('../../../../dist/index-41a8b156.esm.js')).default;
