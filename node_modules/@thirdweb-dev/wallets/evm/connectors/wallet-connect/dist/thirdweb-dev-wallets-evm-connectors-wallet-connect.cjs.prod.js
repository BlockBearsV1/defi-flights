...
class WalletConnectConnector extends errors.Connector {
  constructor(config) {
    super({
      ...config,
      options: {
    ...
    defineProperty._defineProperty(this, "onDisconnect", () => {
      classPrivateMethodGet._classPrivateMethodGet(this, _setRequestedChainsIds, _setRequestedChainsIds2).call(this, []);
  ...
  async connect() {
    ...
    try {
      ...
      if (!provider.session || isChainsStale) {
        ...
        classPrivateMethodGet._classPrivateMethodGet(this, _setRequestedChainsIds, _setRequestedChainsIds2).call(this, this.chains.map(_ref => {
          let {
            chainId
          } = _ref;
          return chainId;
  ...
  async switchChain(chainId) {
    ...
    try {
      ...
      if (!isChainApproved && namespaceMethods.includes(ADD_ETH_CHAIN_METHOD)) {
        ...
        classPrivateMethodGet._classPrivateMethodGet(this, _setRequestedChainsIds, _setRequestedChainsIds2).call(this, requestedChains);
      }
      await provider.request({
...
function _setRequestedChainsIds2(chains) {
  classPrivateFieldSet._classPrivateFieldGet(this, _storage).setItem(REQUESTED_CHAINS_KEY, JSON.stringify(chains));
}
