...
import { resolveProperties, keccak256, defaultAbiCoder, hexConcat, arrayify, defineReadOnly, hexValue } from 'ethers/lib/utils';
import fetch from 'cross-fetch';
import { EntryPoint__factory } from '@account-abstraction/contracts';
import { ThirdwebSDK, getChainProvider } from '@thirdweb-dev/sdk';
import { packUserOp, deepHexlify } from '@account-abstraction/utils';
...
async function create4337Provider(config) {
  ...
  const entryPoint = EntryPoint__factory.connect(config.entryPointAddress, rpcProvider);
...
class SmartWalletConnector extends TWConnector {
  constructor(config) {
    super();
    _defineProperty(this, "config", void 0);
