...
var utils$1 = require('@account-abstraction/utils');
...
async function getUserOpHashV06(userOp, entryPoint, chainId) {
  ...
  let encoded = utils.defaultAbiCoder.encode([userOpType], [{
    ...hashedUserOp
  }]);
...
class VerifyingPaymasterAPI extends sdk.PaymasterAPI {
  constructor(paymasterUrl, entryPoint, apiKey) {
    super();
    defineProperty._defineProperty(this, "paymasterUrl", void 0);
    defineProperty._defineProperty(this, "entryPoint", void 0);
    defineProperty._defineProperty(this, "apiKey", void 0);
  ...
  async getPaymasterAndData(userOp) {
    ...
    const op = await ethers.ethers.utils.resolveProperties(pmOp);

    // console.log("PM - op", op);
    const preVerificationGas = sdk.calcPreVerificationGas(op);
    ...
    try {
      const response = await fetch__default["default"](this.paymasterUrl, {
        method: "POST",
        headers: {
      ...
      console.log("PM - error", e.result?.error || e);
      throw e;
    }
  }
}
...
class BaseAccountAPI {
   ...
   */
  constructor(params) {
    defineProperty._defineProperty(this, "senderAddress", void 0);
    defineProperty._defineProperty(this, "isPhantom", true);
    defineProperty._defineProperty(this, "entryPointView", void 0);
    defineProperty._defineProperty(this, "provider", void 0);
    defineProperty._defineProperty(this, "overheads", void 0);
    defineProperty._defineProperty(this, "entryPointAddress", void 0);
    defineProperty._defineProperty(this, "accountAddress", void 0);
    defineProperty._defineProperty(this, "paymasterAPI", void 0);
   ...
   */
  packUserOp(userOp) {
    return utils$1.packUserOp(userOp, false);
  }
  async encodeUserOpCallDataAndGasLimit(detailsForUserOp) {
    ...
    if (isPhantom) {
      ...
      callGasLimit = ethers.BigNumber.from(500_000);
    } else {
...
class AccountAPI extends BaseAccountAPI {
  constructor(params) {
    const sdk = sdk$1.ThirdwebSDK.fromSigner(params.localSigner, params.chain);
    super({
      ...params,
      provider: sdk.getProvider()
    });
    defineProperty._defineProperty(this, "sdk", void 0);
    defineProperty._defineProperty(this, "params", void 0);
    defineProperty._defineProperty(this, "accountContract", void 0);
    defineProperty._defineProperty(this, "factoryContract", void 0);
    this.params = params;
    this.sdk = sdk;
  }
  async getChainId() {
  ...
  async _getAccountContract() {
    if (!this.accountContract) {
      if (this.params.accountAbi) {
        this.accountContract = await this.sdk.getContract(await this.getAccountAddress(), this.params.accountAbi);
      } else {
  ...
  async getAccountInitCode() {
    ...
    const tx = factory.prepare("createAccount", [localSigner, this.params.accountId]);
    try {
  ...
  async getFactoryContract() {
    ...
    if (this.params.factoryAbi) {
      this.factoryContract = await this.sdk.getContract(this.params.factoryAddress, this.params.factoryAbi);
    } else {
  ...
  async getCounterFactualAddress() {
    const factory = await this.getFactoryContract();
    return factory.call("getAddress", [this.params.accountId]);
  }
  async getNonce() {
    if (await this.checkAccountPhantom()) {
...
class UserOperationEventListener {
  constructor(resolve, reject, entryPoint, sender, userOpHash, nonce, timeout) {
    ...
    defineProperty._defineProperty(this, "boundLisener", void 0);
...
class ERC4337EthersSigner extends ethers.Signer {
  ...
  constructor(config, originalSigner, erc4337provider, httpRpcClient, smartAccountAPI) {
    ...
    defineProperty._defineProperty(this, "originalSigner", void 0);
    defineProperty._defineProperty(this, "erc4337provider", void 0);
    defineProperty._defineProperty(this, "httpRpcClient", void 0);
    defineProperty._defineProperty(this, "smartAccountAPI", void 0);
    defineProperty._defineProperty(this, "address", void 0);
...
class ERC4337EthersProvider extends ethers.ethers.providers.BaseProvider {
  constructor(chainId, config, originalSigner, originalProvider, httpRpcClient, entryPoint, smartAccountAPI) {
    ...
    this.entryPoint = entryPoint;
    this.smartAccountAPI = smartAccountAPI;
    defineProperty._defineProperty(this, "initializedBlockNumber", void 0);
  ...
  async constructUserOpTransactionResponse(userOp1) {
    ...
    return {
      ...
      confirmations: 0,
      from: userOp.sender,
      nonce: ethers.BigNumber.from(userOp.nonce).toNumber(),
...
class HttpRpcClient {
  constructor(bundlerUrl, entryPointAddress, chainId, apiKey) {
    defineProperty._defineProperty(this, "userOpJsonRpcProvider", void 0);
    defineProperty._defineProperty(this, "initializing", void 0);
    defineProperty._defineProperty(this, "bundlerUrl", void 0);
    defineProperty._defineProperty(this, "entryPointAddress", void 0);
  ...
  async sendUserOpToBundler(userOp1) {
    ...
    const hexifiedUserOp = utils$1.deepHexlify(await utils.resolveProperties(userOp1));
 ...
 */
async function create4337Provider(config) {
  const rpcProvider = sdk$1.getChainProvider(config.chain, {
    thirdwebApiKey: config.thirdwebApiKey
  });
  const entryPoint = contracts.EntryPoint__factory.connect(config.entryPointAddress, rpcProvider);
  ...
  return await new ERC4337EthersProvider(chainId, config, config.localSigner, rpcProvider, httpRpcClient, entryPoint, accountApi).init();
}

class SmartWalletConnector extends twConnector.TWConnector {
  constructor(config) {
    super();
    defineProperty._defineProperty(this, "config", void 0);
    defineProperty._defineProperty(this, "aaProvider", void 0);
    defineProperty._defineProperty(this, "personalWallet", void 0);
    this.config = config;
  }
  async initialize(personalWallet, accountId) {
    ...
    const providerConfig = {
      ...
      entryPointAddress,
      bundlerUrl,
      paymasterAPI: this.config.gasless ? getVerifyingPaymaster(paymasterUrl, entryPointAddress, this.config.thirdwebApiKey) : undefined,
      factoryAddress: config.factoryAddress,
      factoryAbi: config.factoryAbi,
      accountAbi: config.accountAbi,
      thirdwebApiKey: config.thirdwebApiKey
  ...
  async connect(connectionArgs) {
    await this.initialize(connectionArgs.personalWallet, connectionArgs.accountId);
