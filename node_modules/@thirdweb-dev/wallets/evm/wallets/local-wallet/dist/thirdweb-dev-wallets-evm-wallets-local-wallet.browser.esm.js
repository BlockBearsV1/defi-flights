...
import { a as AbstractClientWallet, c as createAsyncLocalStorage } from '../../../../dist/base-e1301995.browser.esm.js';
...
class LocalWallet extends AbstractClientWallet {
  ...
  constructor(options) {
    ...
    _classPrivateFieldSet(this, _storage2, options?.storage || createAsyncLocalStorage("localWallet"));
  }
  async getConnector() {
    if (!this.connector) {
      const {
...
_defineProperty(LocalWallet, "id", "localWallet");
