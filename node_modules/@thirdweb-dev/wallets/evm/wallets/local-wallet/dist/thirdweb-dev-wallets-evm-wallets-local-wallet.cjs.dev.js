...
class LocalWallet extends evm_wallets_base_dist_thirdwebDevWalletsEvmWalletsBase.AbstractClientWallet {
  ...
  constructor(options) {
    ...
    classPrivateFieldSet._classPrivateFieldSet(this, _storage2, options?.storage || evm_wallets_base_dist_thirdwebDevWalletsEvmWalletsBase.createAsyncLocalStorage("localWallet"));
  }
  async getConnector() {
    if (!this.connector) {
      const {
        LocalWalletConnector: LocalWalletConnector
      } = await Promise.resolve().then(function () { return require('../../../connectors/local-wallet/dist/thirdweb-dev-wallets-evm-connectors-local-wallet.cjs.dev.js'); });
...
defineProperty._defineProperty(LocalWallet, "id", "localWallet");
